...
The Helm chart installs eav-component and by default the following dependencies using subcharts:
...
```bash
helm install my-eav-component  --version 0.1.0
```
...
| `settings.subdomain` | the subdomain of the installation excluding www. | `eav-component` |
| `settings.subpath` | Any sub path to follow the domain, like /api/v1 | `eav-component` |
